 ...
 */
final class Version20230925212406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE shop (id INT AUTO_INCREMENT NOT NULL, shop_owner_id INT NOT NULL, name VARCHAR(64) NOT NULL, description LONGTEXT NOT NULL, open_hours VARCHAR(64) NOT NULL, city VARCHAR(64) NOT NULL, address VARCHAR(64) DEFAULT NULL, INDEX IDX_AC6A4CA2A5849B6F (shop_owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE shop_category (id INT AUTO_INCREMENT NOT NULL, shop_id INT NOT NULL, name VARCHAR(64) NOT NULL, UNIQUE INDEX UNIQ_DDF4E3575E237E06 (name), INDEX IDX_DDF4E3574D16C4DD (shop_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
