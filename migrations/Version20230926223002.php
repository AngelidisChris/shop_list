 ...
 */
final class Version20230926223002 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE shop (id INT AUTO_INCREMENT NOT NULL, shop_owner_id INT NOT NULL, shop_category_id INT DEFAULT NULL, name VARCHAR(64) NOT NULL, description LONGTEXT NOT NULL, open_hours VARCHAR(64) NOT NULL, city VARCHAR(64) NOT NULL, address VARCHAR(64) DEFAULT NULL, INDEX IDX_AC6A4CA2A5849B6F (shop_owner_id), INDEX IDX_AC6A4CA2C0316BF2 (shop_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
