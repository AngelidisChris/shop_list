 ...
 */
final class Version20230927233836 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE shop (id INT AUTO_INCREMENT NOT NULL, shop_owner_id INT NOT NULL, shop_category_id INT NOT NULL, name VARCHAR(64) NOT NULL, description LONGTEXT NOT NULL, open_hours JSON NOT NULL, city VARCHAR(64) NOT NULL, address VARCHAR(64) DEFAULT NULL, UNIQUE INDEX UNIQ_AC6A4CA25E237E06 (name), INDEX IDX_AC6A4CA2A5849B6F (shop_owner_id), INDEX IDX_AC6A4CA2C0316BF2 (shop_category_id), INDEX shop_owner_shop_category_city_idx (shop_owner_id, shop_category_id, city), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
